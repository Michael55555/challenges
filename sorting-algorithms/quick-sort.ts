...
const drawData = (ctx: CanvasRenderingContext2D, arr: Array<number>) => {
...
const quickSort = async (array: Array<number>, start: number, end: number) => {
  if (start >= end) return
...
const partition = async (array: Array<number>, start: number, end: number) => {
